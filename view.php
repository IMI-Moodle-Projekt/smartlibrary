...
if ($courseid > 0) {
    ...
    echo '<div style="display: flex; justify-content: flex-end; align-items: right;">'; // Use justify-content: flex-end;
...
.keyword-box {
    border: 1px solid #000; /* black border, adjust as needed */
    padding: 10px; /* space inside the box, adjust as needed */
    margin: auto; /* centers the box in its container */
    text-align: center; /* centers the text */
    font-weight: bold; /* makes text bold */
    max-width: 80%; /* maximum width of the box, adjust as needed */
    box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); /* subtle shadow, optional */
    background-color: #f9f9f9; /* light gray background, adjust as needed */
}
...
/* Add a class to style the flex container */
.keyword-group li {
    margin-bottom: 5px;
...
/* Style the logo to have some spacing from the link and name */
.keyword-group .logo-icon {
    max-width: 50px; /* Set the maximum width to 50 pixels */
    height: auto; /* Automatically adjust the height to maintain aspect ratio */
    margin-left: auto; /* Push the logo to the far right within the flex container */
}
</style>';

...
function beliefmedia_keywords($string, $min_word_length = 3, $min_word_occurrence = 2, $as_array = false, $max_words = 8, $restrict = false) {
    ...
    */
    ...
    'you', 'you\'d', 'you\'ll', 'you\'re', 'you\'ve', 'your', 'yours', 'yourself', 'yourselves', 'ask', 'be', 'become', 'begin', 'call', 'can', 'come', 'could', 'do', 'feel', 'find', 'get', 'give', 'go', 'have', 'hear', 'help', 'keep', 'know', 'leave', 'let', 'like', 'live', 'look', 'make', 'may', 'mean', 'might', 'move', 'need', 'play', 'put', 'run', 'say', 'see', 'seem', 'should', 'show', 'start', 'take', 'talk', 'tell', 'think', 'try', 'turn', 'use', 'want', 'will', 'work', 'would',  'able', 'bad', 'best', 'better', 'big', 'black', 'certain', 'clear', 'different', 'early', 'easy', 'economic', 'federal', 'free', 'full', 'good', 'great', 'hard', 'high', 'human', 'important', 'international', 'large', 'late', 'little', 'local', 'long', 'low', 'major', 'military', 'national', 'new', 'old', 'only', 'other', 'political', 'possible', 'public', 'real', 'recent', 'right', 'small', 'social', 'special', 'strong', 'sure', 'true', 'white', 'whole', 'young', 'again', 'already', 'always', 'back', 'better', 'best', 'even', 'ever', 'far', 'fast', 'hard', 'hardly', 'high', 'how', 'late', 'long', 'low', 'more', 'most', 'much', 'near', 'never', 'now', 'often', 'only', 'perhaps', 'quite', 'really', 'right', 'soon', 'still', 'then', 'there', 'together', 'too', 'very', 'well', 'yet',  'the', 'for', 'an', 'as', 'how', 'to', 'and', 'of', 'a', 'with', 'that', 'your', 'well', 'as', 'using', 'what', 'you\'ll', 'learn', 'check', 'test');
